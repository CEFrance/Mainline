...
namespace XpressNetSharp
{
    public class Message : Packet, IObserver<Packet>
    {
        ...
        public virtual async void OnError(Exception e)
        {
            ...
            {
                await Console.Out.WriteLineAsync($"{ToString()}: Cannot get packet from router.");
            }
        }
        ...
        private bool ValidGeneralResponse(Packet p)
        {
            ...
            if(p.Header == PacketHeaderType.CommunicationsStateResponse &&
